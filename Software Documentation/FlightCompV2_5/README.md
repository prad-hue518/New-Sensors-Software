# FlightCompV2.5 - Rocketry Flight Computer

## Overview

FlightCompV2.5 is a modular, PID-controlled flight computer designed for model rockets. It is built for the **Teensy 4.1** microcontroller and integrates sensor fusion and active stabilization to maintain flight orientation and manage recovery systems.
...
```text
FlightCompV2_5/
├── FlightCompV2_5.cpp                      <- Main entry point
└── src/
    ├── Config/
